  ...
  if (interaction.isModalSubmit()) {
    if (interaction.customId === 'video_modal') {
      ...
      await updateData('partners', {
        ...
        socialsList: [interaction.fields.getTextInputValue('partner_fb_ig'), interaction.fields.getTextInputValue('partner_tiktok_yt'), interaction.fields.getTextInputValue('partner_dc')].filter(Boolean),
        date: new Date().toISOString()
      });
      await interaction.reply({ content: `✅ **เพิ่มพัธมิตรสำเร็จ!**`, flags: MessageFlags.Ephemeral });
